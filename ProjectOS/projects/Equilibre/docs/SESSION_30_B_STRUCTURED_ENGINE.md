...
`SESSION-30-C-PREP` propose désormais storage-v5 / IndexedDB dans l'ADR-007 et découpe la suite en C0–C4. Après acceptation, C0 sécurise la montée de version, C1 réalise la migration et C2/C3 branchent progressivement le moteur validé sans déplacer les règles de domaine dans l'UI.
