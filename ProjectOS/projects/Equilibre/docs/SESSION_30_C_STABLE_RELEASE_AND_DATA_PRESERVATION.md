...
- Statut : préparation acceptée ; C0 intégré par la PR #134 ; C1 prochain incrément
...
Construire **C1 — Storage-v5** depuis le socle C0 intégré. C1 introduit le repository IndexedDB et la migration v4→v5 transactionnelle avec checkpoint, sans rendre SESSION-30 visible et sans activer deux writers concurrents.
