...
> Identifie le projet, charge son manifeste et ses ADR, vérifie l’état GitHub, crée une branche dédiée, implémente la demande, teste, documente et crée le compte rendu temporaire. Livre par Pull Request lorsque l’accès GitHub le permet ; sinon produis une livraison de repli récupérable conforme à `AGENT_HANDOFFS.md`.

## Corriger

> Reproduis le défaut à partir des preuves disponibles, identifie la cause racine, applique la correction minimale, ajoute un test de non-régression, crée le compte rendu temporaire et livre par Pull Request ou par bundle de repli récupérable.
