...
5. ne pas utiliser une copie mémorisée lorsqu’une référence vivante est accessible ;
6. traiter ensuite la demande de l’utilisateur selon les documents résolus.
